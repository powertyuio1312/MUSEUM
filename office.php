		...
		<div class="container">
			...
			<?php
                    ...
                    $queryLog = "SELECT photo, exName, author, content, date, time, price ,exhibition_id
                                FROM `reservation` left JOIN `exhibition`
                                ON reservation.exID = exhibition.exhibition_id
                                LEFT JOIN `user`
...
echo "<h1>Заказы ($countexNamerows)</h1>
    ...
    for($i = 0; $i < $countexNamerows; ++$i)
    {
    	...
    	echo "<div class='row ex-row fadeInRight wow' data-wow-offset='200' 
			...
			?>
                ...
                <img class='img-like' src='img/LikeOn.png' width='100%'>
            } -->
